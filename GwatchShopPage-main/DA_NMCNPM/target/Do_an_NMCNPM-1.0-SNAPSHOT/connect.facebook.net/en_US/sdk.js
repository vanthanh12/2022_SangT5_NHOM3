/*1498882979,,JIT Construction: v3130986,en_US*/
...
try {
        ...
        (function () {
            ...
            with (this) {
                 ...
                 */__d("JSON3", [], (function a(b, c, d, e, f, g) {
                    (function () {
                        var h = {}.toString, i, j, k, l = f.exports = {},
                            m = '{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}', n, o, p, q, r, s, t, u, v, w, x,
                            y, z, aa, ba, ca = new Date(-3509827334573292), da, ea, fa;
                        try {
                ...
                __d('ES', ['ES5ArrayPrototype', 'ES5FunctionPrototype', 'ES5StringPrototype', 'ES5Array', 'ES5Object', 'ES5Date', 'JSON3', 'ES6Array', 'ES6Object', 'ES6ArrayPrototype', 'ES6DatePrototype', 'ES6Number', 'ES7StringPrototype', 'ES7Object', 'ES7ArrayPrototype'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    var w = {}.toString, x = {'JSON.stringify': n.stringify, 'JSON.parse': n.parse}, y = {
                            'Array.prototype': h,
                ...
                __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "3130986"});
                __d("JSSDKConfig", [], {
                    "bustCache": true,
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    var w, x, y, z = m.MAX_QUERYSTRING_LENGTH, aa = {get: true, post: true, 'delete': true, put: true},
                        ba = {
                            fql_query: true,
                            fql_multiquery: true,
                            friends_get: true,
                            ...
                            stream_get: true,
                            users_getinfo: true
                        }, ca = ['jsonp', 'cors', 'flash'], da = [], ea = [], fa = null, ga = 0, ha = [], ia = 0,
                        ja = 50, ka = 105440539523;
                ...
                __d('sdk.AppEvents', ['AppUserPropertyAPIBuiltinField', 'Assert', 'ApiClient', 'sdk.Event', 'sdk.Impressions', 'sdk.Model', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                    var q = {
                        ...
                        }, r = {ACTIVATED_APP: 'fb_mobile_activate_app', PURCHASED: 'fb_mobile_purchase'}, s = {
                        ...
                        }, t = /^[0-9a-zA-Z_][0-9a-zA-Z _-]{0,39}$/, u = 40, v = t, w = u, x = 100, y = 100, z = 100,
                        aa = 100, ba = ES('Object', 'values', false, h), ca = new m({UserID: '', Version: ''});

                    function da(ua, va, wa, xa) {
                        var ya = {ae: 1, ev: va, vts: wa, canvas: 1};
                        if (xa) ya.cd = xa;
                        l.impression({api_key: ua, payload: ES('JSON', 'stringify', false, ya)});
                    }

                    function ea(ua, va, wa, xa) {
                        var ya = p.getAuthResponse(), za = ya && ya.accessToken ? ya.accessToken : null;
                        o.logEvent(ua, va, xa || {}, wa, za);
                    }

                    function fa(ua, va, wa, xa) {
                        ga(va);
                        var ya = ca.getUserID();
                        if (ya !== '') {
                            xa = xa || {};
                        ...
                        var za = ca.getVersion();
                        if (za !== '') {
                            xa = xa || {};
                            xa[s.APP_VERSION] = za;
                        }
                        if (n.isCanvasEnvironment()) {
                            da(ua, va, wa, xa);
                        } else ea(ua, va, wa, xa);
                    }

                    function ga(ua) {
                        i.isTrue(t.test(ua), 'Invalid event name: ' + ua + '. ' + 'It must be between 1 and ' + u + ' characters, ' + 'and must be contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _.');
                    }

                    function ha(ua, va, wa, xa) {
                        var ya = {};
                        ya[s.CURRENCY] = wa;
                        fa(ua, r.PURCHASED, va, babelHelpers['extends']({}, xa, ya));
                    }

                    function ia(ua) {
                        fa(ua, r.ACTIVATED_APP);
                    }
                    ...
                    function ka(ua) {
                        i.isTrue(ua.length !== 0, 'User ID must be set before updateUserProperties can be called.');
                        i.isTrue(ua.length <= x, 'Invalid user ID: ' + ua + '. ' + 'It must be no longer than ' + x + ' characters.');
                    }
                    ...
                    function oa(ua) {
                        i.isTrue(ua.length <= y, 'Invalid app version: ' + ua + '. ' + 'It must be no longer than ' + y + ' characters.');
                    }
                    ...
                    function sa(ua) {
                        i.isTrue(ES('Object', 'keys', false, ua).length <= z, 'The total number of user properties cannot exceed ' + z + '.');
                        for (var va in ua) {
                            i.isTrue(v.test(va) || ES(ba, 'includes', true, va), 'Invalid user properties key name: ' + va + '. ' + 'It must be between 1 and ' + w + ' ' + 'characters, and must contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _. ' + 'Or, it must be a pre-defined user property');
                            i.isTrue(ua[va].toString().length <= aa, 'Invalid user properties value: ' + ua[va] + '. ' + 'It must be no longer than ' + aa + ' characters.');
                        }
                    }

                    function ta(ua, va, wa) {
                        var xa = ma();
                        ka(xa);
                        sa(va);
                        var ya = '/' + ua + '/user_properties', za = {data: [{user_unique_id: xa, custom_data: va}]};
                        j.graph(ya, 'post', za, wa);
                    }

                    k.subscribe('init:post', function (ua) {
                        if (n.getClientID()) {
                            if (ua.autoLogAppEvents !== undefined) {
                                i.isBoolean(ua.autoLogAppEvents, 'Type of property autoLogAppEvents must be boolean');
                                n.setAutoLogAppEvents(ua.autoLogAppEvents);
                            }
                            if (n.getAutoLogAppEvents()) ja(n.getClientID());
                        }
                    });
                    f.exports = {
                        activateApp: ia,
                        ...
                        logPurchase: ha,
                        logPageView: ja,
                        assertValidEventName: ga,
                        EventNames: q,
                        ParameterNames: s,
                        assertValidUserID: ka,
                        setUserID: la,
                        getUserID: ma,
                        clearUserID: na,
                        assertValidUserProperties: sa,
                        updateUserProperties: ta,
                        setAppVersion: pa,
                        getAppVersion: qa,
                        clearAppVersion: ra,
                        assertValidAppVersion: oa
                    };
                }), null);
                    ...
                    var u = m.extend({
                        ...
                        _repositionIframe: function w(x) {
                            var y = this.getIframeNode(), z = parseInt(k.getStyle(y, 'width'), 10),
                                aa = k.getPosition(y).x, ba = k.getViewportInfo().width, ca = parseInt(x.width, 10);
                            if (aa + ca > ba && aa > ca) {
                ...
                __d('sdk.XFBML.Quote', ['sdk.DOM', 'DOMEventListener', 'IframePlugin', 'UnicodeUtils', 'sdk.UA', 'sdk.XD', 'containsNode', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function aa(da) {
                        var ea = w && w.offsetWidth, fa = ea ? w.offsetHeight : r, ga = ea ? w.offsetWidth : q,
                            ha = da.getRangeAt(0), ia = document.createElement('span'),
                            ja = document.createElement('span'), ka = document.createRange();
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3130986","namespace":"FB","message":"' + e.message + '"}}');
}