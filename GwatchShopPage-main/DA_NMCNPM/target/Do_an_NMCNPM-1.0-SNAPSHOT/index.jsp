                    ...
                    <div class="quickview-information">
                        ...
                        <div class="form-input" style="width: 100%">
                            ...
                            <div class="qv-readmore">
                                <span>hoặc </span><a class="read-more p-url" href="chitietsanpham.html" role="button">Xem
                                chi tiết</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="slider-default bannerslider">
                <div class="hrv-banner-container">
                    <div class="hrvslider">
                        <ul class="slides">
                            <li>
                                <a href="chitietsanpham.html" class="hrv-url">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <a href="chitietsanpham.html"
                                               title="ĐỒNG HỒ SKMEI DÂY DA MẪU DH03 CHẠY FULL KIM">
                                                <img class="first-image  has-img"
                                                     ...
                                                     src="./product.hstatic.net/1000177652/product/1_cfd2a,2d52eb44e74b0ad5da426f861a7_large.jpg"/>
                    ...
                    <div class="container-contact100">
                        <div class="contact100-map" id="google_map" data-map-x="40.722047" data-map-y="-73.986422"
                            ...
                            <img src="../OXYWATCH GIAO DIEN/theme.hstatic.net/1000177652/1000229231/14/map2.jpg"
                                 style="height: 500px;width: 550px; margin-top: 200px;">
                        </div>

                        <div style="position: fixed;margin-left: 1075px;margin-top: 200px;border: 2px solid gray; width: 20px;box-shadow: 4px 4px 4px 2px rgba(250, 3, 3, 0.2);"
                             class="contact100-more">
